...
Create-Dir "$ClaudeDir\skills\bug-diagnosis-guide"
Write-Host ""
...
Copy-FileWithConfirm "$ScriptDir\.claude\skills\bug-diagnosis-guide\SKILL.md" "$ClaudeDir\skills\bug-diagnosis-guide\SKILL.md"
Write-Host ""
...
Write-Host "  - /run-plan"
Write-Host "  - /bug-diagnosis-guide"
Write-Host ""
